...
import pl.greywarden.tutorial.domain.mapper.BlogEntryMapper;
...
public class BlogEntriesService {
    ...
    public void createBlogEntry(CreateBlogEntryRequest createBlogEntryRequest) {
        var test = blogEntryMapper.toEntity(createBlogEntryRequest);
        var saved = blogEntriesRepository.save(test);
